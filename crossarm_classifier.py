...
def classify_crossarm_shape(
    ...
    if "t_rising" in native_class or "t_arm" in native_class or "t-rising" in native_class:
    ...
    if "v_cross" in native_class or "v_arm" in native_class or "v cross" in native_class:
        return CrossarmResult(
    ...
    if native_class in ["side_arm_channel", "tapping_channel", "side arm", "tapping arm", "box arm"] or "side arm" in native_class or "tapping arm" in native_class or "box arm" in native_class:
        return CrossarmResult(
